...
pub const SOL_MINT_KEY: Pubkey = pubkey!("So11111111111111111111111111111111111111111");
...
/// PumpFun global address - Global state account for PumpFun platform
pub const PUMP_GLOBAL_ADDRESS: Pubkey = pubkey!("4wTV1YmiEkRvAtNtsSGPtUrqRYQMe5SKy2uB4Jjaxnjf");

/// PumpFun fee address - Fee collection address for PumpFun platform
pub const PUMP_FEE_ADDRESS: Pubkey = pubkey!("CebN5WGQ4jvEPvsVU4EoHEpgzq1VV7AbicfhtW4xC9iM");

/// PumpFun mint authority - Authority that can mint new PumpFun tokens
pub const PUMP_FUN_MINT_AUTHORITY: Pubkey = pubkey!("TSLvdd1pWpHVjahSpsvCXUbgwsL3JAcvokwaKt1eokM");

/// PumpFun event authority - Authority for PumpFun events
pub const EVENT_AUTHORITY: Pubkey = pubkey!("Ce6TQqeHC9p8KetsN6JsjHK7UTZk7nasjjnr7XxXp9F1");

/// Solana
/// Associated Token Program ID - The SPL Associated Token Account
